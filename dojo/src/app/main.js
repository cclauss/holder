define([
  ...
  "esri/layers/FeatureLayer",
      ...
      "coordinate/CoordinateWidget"
], function(dom,Map, urlUtils, arcgisUtils, ColorInfoSlider,FeatureLayer,InfoTemplate,SimpleMarkerSymbol,SimpleRenderer,webMercatorUtils,CoordinateWidget) {
  ...
  arcgisUtils
    ...
    .then(function(response) {
      ...
      map.on("click",clicked)
         ...
         // coordinate widget
         var coordinateWidget = new CoordinateWidget({
          map: map
        }, "cont");
